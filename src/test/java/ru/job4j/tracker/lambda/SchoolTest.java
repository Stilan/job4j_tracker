...
public class SchoolTest {
    ...
    public void setUp() {
        ...
        students.add(new Student(80, "Surname9"));
...
//    }
    ...
    public void whenConvertingListToMap() {
      ConvertingListToMap convertingListToMap = new ConvertingListToMap();
      Map<String, Student> rsl = convertingListToMap.isListToMap(students);
